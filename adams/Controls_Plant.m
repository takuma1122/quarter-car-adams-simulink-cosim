% Adams / MATLAB Interface - Release 2024.1.0
...
elseif strcmp(machine, 'PCWIN64')
   ...
   [flag, topdir]=system('adams2024_1 -top');
if flag == 0
  ...
  addpath( 'C:\PROGRA~1\MSC~1.SOF\Adams\2024_1\controls/win64' ) ;
  addpath( 'C:\PROGRA~1\MSC~1.SOF\Adams\2024_1\controls/matlab' ) ;
  addpath( 'C:\PROGRA~1\MSC~1.SOF\Adams\2024_1\controls/utils' ) ;
  ADAMS_sysdir = 'C:\PROGRA~1\MSC~1.SOF\Adams\2024_1\' ;
end
ADAMS_exec = '' ;
ADAMS_host = 'Adams_Host' ;
ADAMS_cwd ='C:\work\adams' ;
ADAMS_prefix = 'Controls_Plant' ;
ADAMS_static = 'yes' ;
ADAMS_solver_type = 'C++' ;
ADAMS_version = '2024_1' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'var_actuator!var_road_disp' ;
ADAMS_outputs = 'var_sprung_acc!var_sprung_vel!var_susp_stroke!var_susp_vel!var_tire_disp!var_unsprung_vel' ;
ADAMS_pinput = 'Controls_Plant.ctrl_pinput' ;
ADAMS_pinput_id = 2 ;
ADAMS_poutput = 'Controls_Plant.ctrl_poutput' ;
ADAMS_poutput_id = 2 ;
ADAMS_uy_ids  = [
                   37
                   170
